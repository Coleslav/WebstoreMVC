...
public class InMemoryProductRepository implements ProductRepository {
    ...
    public InMemoryProductRepository(){
        ...
        Product tablet_Nextus = new Product("P1236","Nexus 7",new BigDecimal(300));
        tablet_Nextus.setDescription("Google Nexus 7 jest najlżejszym 7-calowym tabletem z 4-rdzeniowym procesorem Qualcom Snapdragon S4 Pro");
        tablet_Nextus.setCategory("Tablet");
        tablet_Nextus.setManufacturer("Google");
        tablet_Nextus.setUnitsInStock(1000);
